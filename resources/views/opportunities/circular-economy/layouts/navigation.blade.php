...
<style>
    ...
    .logo-header-bg {
        ...
        background-image: linear-gradient(90deg, 
            ...
            rgba(0, 127, 0, 0.2) 100%
        );
        z-index: 0;
    }
    
    /* Lighter gradient for mobile to improve readability */
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-4 col-md-3 d-flex align-items-center justify-content-start">
                <div>
                    <img src="{{ asset('images/logo.png') }}" alt="Wete Government" class="logo-img img-fluid">
                </div>
            </div>
            ...
            <div class="col-6 col-md-6 d-flex flex-column align-items-center justify-content-center">
                ...
                <h1 class="government-title">WETE WASTE MANAGEMENT</h1>
                <div class="government-subtitle">Sustainable Waste Solutions</div>
            </div>
            
            <div class="col-2 col-md-3 d-flex justify-content-end align-items-center">
                <img src="{{ asset('images/zanzibar-logo.png') }}" alt="Zanzibar Coat of Arms" class="logo-img img-fluid">
            </div>
        </div>
    </div>
</header>
