...
@section('meta_description', __('Discover sustainable waste management systems and circular economy opportunities in Pemba that reduce waste and promote resource efficiency.'))
        ...
        <div class="col-md-10 offset-md-1">
            <div class="card shadow-sm">
                <div class="card-body p-4">
                    <div class="row">
                        <div class="col-md-4">
                            <img src="{{ asset('images/data-dashboard.svg') }}" alt="Circular Economy Illustration" class="img-fluid mb-3">
                        </div>
                        <div class="col-md-8">
                            ...
                            <div class="mt-4" role="group" aria-label="Waste management navigation options">
...
<a href="{{ route('opportunities.circular-economy.waste.marketplace') }}" class="btn btn-outline-primary mb-2">{{ __('Waste Marketplace') }}</a>
    ...
    <div class="row">
        <div class="col-md-10 offset-md-1">
            <h2 class="mb-4" id="key-features">{{ __('Key Features') }}</h2>
        </div>
    </div>
    ...
    <div class="row mb-4">
        <div class="col-md-5 offset-md-1">
            <div class="card h-100 shadow-sm">
                <div class="card-body p-4">
                    <h3 class="h5 card-title"><i class="fas fa-map-marked-alt text-primary me-2" aria-hidden="true"></i>{{ __('Waste Collection Map') }}</h3>
        ...
        <div class="col-md-5">
            <div class="card h-100 shadow-sm">
                <div class="card-body p-4">
                    <h3 class="h5 card-title"><i class="fas fa-recycle text-primary me-2" aria-hidden="true"></i>{{ __('Recycling Information') }}</h3>
    ...
    <div class="row mb-5">
        <div class="col-md-5 offset-md-1">
            <div class="card h-100 shadow-sm">
                <div class="card-body p-4">
                    <h3 class="h5 card-title"><i class="fas fa-store text-primary me-2" aria-hidden="true"></i>{{ __('Waste Marketplace') }}</h3>
        ...
        <div class="col-md-5">
            <div class="card h-100 shadow-sm">
                <div class="card-body p-4">
                    <h3 class="h5 card-title"><i class="fas fa-clipboard-check text-primary me-2" aria-hidden="true"></i>{{ __('Waste Assessment Tool') }}</h3>
