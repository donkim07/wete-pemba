...
@section('title', __('Create Opportunity'))
...
<div class="container-fluid px-4">
    <h1 class="mt-4">{{ __('Create Opportunity') }}</h1>
        ...
        <div class="card-body">
            <form action="{{ route('admin.opportunities.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <small class="text-muted">{{ __('Recommended size: 800x600px. Max size: 2MB.') }}</small>
                                    @error('image')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="card mt-3">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('application_process') is-invalid @enderror" id="application_process" name="application_process" rows="3">{{ old('application_process') }}</textarea>
                ...
                <div class="d-flex justify-content-end mt-4">
                    ...
                    <button type="submit" class="btn btn-primary">{{ __('Create Opportunity') }}</button>
                </div>
            </form>
        </div>
    </div>
