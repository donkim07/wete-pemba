        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">{{ __('Add New Content Block') }}</h5>
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <x-text-input id="identifier" name="identifier" type="text" class="form-control" :value="old('identifier')" required />
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <select id="type" name="type" class="form-select">
                                        ...
                                        <option value="html" {{ old('type') == 'html' ? 'selected' : '' }}>{{ __('HTML') }}</option>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <x-text-input id="section" name="section" type="text" class="form-control" :value="old('section')" />
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <x-text-input id="order" name="order" type="number" class="form-control" :value="old('order', 0)" min="0" />
                        ...
                        <div class="tab-content" id="langTabContent">
                            <div class="tab-pane fade show active" id="english" role="tabpanel" aria-labelledby="english-tab">
                                <div class="mb-3">
                                    ...
                                    <x-text-input id="title" name="title" type="text" class="form-control" :value="old('title')" />
                                ...
                                <div class="mb-3 content-field d-none" id="html-content-en">
                                    ...
                                    <textarea id="content_html" name="content" class="form-control editor" rows="8">{{ old('content') }}</textarea>
                                    <x-input-error :messages="$errors->get('content')" class="mt-2" />
                                </div>
                                ...
                                <div class="mb-3 content-field d-none" id="form-content-en">
                                    ...
                                    <select id="form_builder_id" name="form_builder_id" class="form-select">
                                        ...
                                        @foreach($forms as $id => $title)
                                            <option value="{{ $id }}" {{ old('form_builder_id') == $id ? 'selected' : '' }}>
                                                {{ $title }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="tab-pane fade" id="swahili" role="tabpanel" aria-labelledby="swahili-tab">
                                ...
                                <div class="mb-3 content-field" id="text-content-sw">
                                    ...
                                    <textarea id="content_sw" name="content_sw" class="form-control" rows="8">{{ old('content_sw') }}</textarea>
                                ...
                                <div class="mb-3 content-field d-none" id="html-content-sw">
                                    ...
                                    <textarea id="content_html_sw" name="content_sw" class="form-control editor" rows="8">{{ old('content_sw') }}</textarea>
                                    <x-input-error :messages="$errors->get('content_sw')" class="mt-2" />
                                </div>
