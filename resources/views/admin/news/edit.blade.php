        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">{{ __('Edit Article') }}</h5>
                        ...
                        <div class="tab-content" id="langTabContent">
                            <div class="tab-pane fade show active" id="english" role="tabpanel" aria-labelledby="english-tab">
                                <div class="mb-3">
                                    ...
                                    <x-text-input id="title" name="title" type="text" class="form-control" :value="old('title', $news->title)" required autofocus />
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea id="content" name="content" class="form-control editor" rows="10">{{ old('content', $news->content) }}</textarea>
                            ...
                            <div class="tab-pane fade" id="swahili" role="tabpanel" aria-labelledby="swahili-tab">
                                <div class="mb-3">
                                    ...
                                    <x-text-input id="title_sw" name="title_sw" type="text" class="form-control" :value="old('title_sw', $news->title_sw)" />
                                    <x-input-error :messages="$errors->get('title_sw')" class="mt-2" />
                                </div>
                                
                                <div class="mb-3">
                                    <x-input-label for="excerpt_sw" :value="__('Excerpt (Swahili)')" />
                                    <textarea id="excerpt_sw" name="excerpt_sw" class="form-control" rows="3">{{ old('excerpt_sw', $news->excerpt_sw) }}</textarea>
                                    <x-input-error :messages="$errors->get('excerpt_sw')" class="mt-2" />
                                </div>
                                
                                <div class="mb-3">
                                    <x-input-label for="content_sw" :value="__('Content (Swahili)')" />
                                    <textarea id="content_sw" name="content_sw" class="form-control editor" rows="10">{{ old('content_sw', $news->content_sw) }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select id="category_id" name="category_id" class="form-select">
                                        ...
                                        @foreach($categories as $id => $name)
                                            <option value="{{ $id }}" {{ old('category_id', $news->category_id) == $id ? 'selected' : '' }}>
                                                {{ $name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    @if($news->featured_image)
                                        <div class="mt-2">
                                            <img src="{{ asset('images/' . $news->featured_image) }}" alt="{{ $news->title }}" class="img-thumbnail" style="max-height: 150px;">
