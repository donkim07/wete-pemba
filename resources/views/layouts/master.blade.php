            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-4 text-md-start text-center">
                        <a href="{{ route('home') }}">
                            <img src="{{ asset('images/logo-left.png') }}" alt="Government of Tanzania Logo" class="gov-logo" height="60">
                        </a>
                    </div>
                    <div class="col-md-4 text-center mt-2 mt-md-0">
                        <h1 class="portal-title fs-4 fw-bold">WETE-WASTE PORTAL</h1>
                    </div>
                    <div class="col-md-4 text-md-end text-center mt-2 mt-md-0">
                        <img src="{{ asset('images/logo-right.png') }}" alt="Wete District Logo" class="gov-logo" height="60">
                    </div>
                </div>
            </div>
        </div>
