                ...
                <div class="card-body p-0">
                    <div class="list-group list-group-flush">
                        <a href="{{ url('/government/publications') }}" class="category-link {{ !request('category') ? 'active' : '' }}">
                            ...
                            <span class="badge rounded-pill">{{ $totalPublications ?? 0 }}</span>
                        </a>
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="section-title mb-0">
                    @if(request('category') && isset($currentCategory))
                        {{ is_object($currentCategory) ? $currentCategory->name : ucfirst($currentCategory) }}
                    @else
                        All Publications
                    @endif
                </h2>
                            ...
                            <div class="card-body">
                                ...
                                @if($publication->category)
                                    <div class="publication-category text-center mb-2">
                                        <i class="fas fa-tag me-1"></i> {{ is_object($publication->category) ? $publication->category->name : ucfirst($publication->category) }}
                                    </div>
                                @endif
