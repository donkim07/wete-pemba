...
// News Cards Template
function addNewsCardsTemplate(sectionId) {
    // Add heading
    $(`.components-container[data-section="${sectionId}"]`).append(
        createComponentHtml({
            id: 'new-' + Date.now(),
            title: 'News Cards Heading',
            type: 'text',
            column_width: 12,
            section: sectionId,
            content: '<h2 class="text-center mb-4">Latest News</h2><p class="text-center mb-5">Stay updated with our latest news and announcements.</p>'
        })
    );
    ...
    $(`.components-container[data-section="${sectionId}"]`).append(
        createComponentHtml({
            ...
            meta_data: {
                ...
                image: '/storage/placeholder/news-1.jpg',
                button_text: 'Read More',
                button_url: '/news/sample-1',
                excerpt: 'This is a brief excerpt from the first news article. Click to read more about this topic.'
            },
            content: ''
        })
    );
    ...
    $(`.components-container[data-section="${sectionId}"]`).append(
        createComponentHtml({
            ...
            meta_data: {
                ...
                image: '/storage/placeholder/news-2.jpg',
                button_text: 'Read More',
                button_url: '/news/sample-2',
                excerpt: 'This is a brief excerpt from the second news article. Click to read more about this topic.'
            },
            content: ''
        })
    );
    ...
    $(`.components-container[data-section="${sectionId}"]`).append(
        createComponentHtml({
            ...
            meta_data: {
                title: 'News Title 3',
                subtitle: 'May 18, 2023',
                image: '/storage/placeholder/news-3.jpg',
                button_text: 'Read More',
                button_url: '/news/sample-3',
                excerpt: 'This is a brief excerpt from the third news article. Click to read more about this topic.'
            },
            content: ''
        })
    );
...
// Government homepage hero swiper initialization
