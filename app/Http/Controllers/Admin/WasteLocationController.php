...
class WasteLocationController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.opportunities.circular-economy.waste-locations.index', compact('wasteLocations', 'locationTypes'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.opportunities.circular-economy.waste-locations.create', compact('locationTypes', 'acceptedMaterials'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('image') && $request->file('image')->isValid()) {
            $path = $request->file('image')->store('waste-locations', 'public');
        ...
        return redirect()->route('admin.opportunities.circular-economy.waste-locations.edit', $wasteLocation)
    ...
    public function show(string $id)
    {
        ...
        return view('admin.opportunities.circular-economy.waste-locations.show', compact('wasteLocation'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('admin.opportunities.circular-economy.waste-locations.edit', compact('wasteLocation', 'locationTypes', 'acceptedMaterials'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        if ($request->hasFile('image') && $request->file('image')->isValid()) {
            ...
            if (!empty($wasteLocation->image)) {
                Storage::disk('public')->delete($wasteLocation->image);
            }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('admin.opportunities.circular-economy.waste-locations.index')
